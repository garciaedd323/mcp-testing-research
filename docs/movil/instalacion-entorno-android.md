...
👉 Continúa en: [Decisión: Claude Desktop vs Claude Code](./decision-claude-desktop-vs-code.md) → luego [Paso 3 (revisado) para Claude Code](./paso3-conectar-appium-claude-code.md)
